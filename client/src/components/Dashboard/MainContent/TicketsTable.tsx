                  ...
                  <tr>
                    ...
                    <th scope="col" className="px-5 py-3.5 text-sm font-normal text-left  text-gray-500 dark:text-gray-400">
                      <button className="flex items-center gap-x-2"
                        onClick={() => props.onSort("shortDescription")}>
                        <span>Tickets</span>
                    ...
                    <th scope="col" className=" px-2 py-3.5 text-sm font-normal text-center text-gray-500 dark:text-gray-400">
                    ...
                    <th scope="col" className="px-5 py-3.5 text-sm font-normal text-left  text-gray-500 dark:text-gray-400">
                      <button className="flex items-center gap-x-2"
                        onClick={() => props.onSort("assignedToId")}>
                    ...
                    <th scope="col" className="px-5 py-3.5 text-sm font-normal text-left  text-gray-500 dark:text-gray-400">
                      <button className="flex items-center gap-x-2"
                        onClick={() => props.onSort("createdDate")}>
                    ...
                    <tr key={ticket.id} >
                      ...
                      {(ticket.assignedTo && ticket.assignedTo.email) ? (
                        <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap"
                          onClick={() => props.onSelectedTicket(ticket)}>
                        ...
                        (<td onClick={() => props.onSelectedTicket(ticket)} className="px-4 py-4 text-sm text-gray-700 dark:text-gray-300 whitespace-nowrap max-w-lg truncate">Not assigned</td>)
                      }

                      {/* Created date */}
                      <td onClick={() => props.onSelectedTicket(ticket)} className="px-4 py-4 text-sm text-gray-700 dark:text-gray-300 whitespace-nowrap max-w-lg truncate">{new Date(ticket.createdDate.toString()).toLocaleDateString()}</td>
